...
// String sql3 ="select pid,pname,imageName,pprice from products where keywords LIKE  '"+key+"'   ";
// String sql2 ="select pid,pname,imageName,pprice from products where pid='b3'   ";
 resultSet = statement.executeQuery("select pid,pname,imageName,pprice from products where keywords LIKE '%"+key+"%' " );
